    ...
    def ui(self, is_img2img):
        with gr.Blocks():
            with gr.Box():
                ...
                with gr.Row():
                    denoising_strength_change_factor = gr.Slider(minimum=0, maximum=1, step=0.01, label='Denoise Change:', value=0.5, elem_id=self.elem_id("denoising_strength_change_factor"))            
            with gr.Box():
                with gr.Row():
